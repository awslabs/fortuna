...
from transformers.models.roberta.modeling_flax_roberta import FlaxRobertaModule, create_position_ids_from_input_ids
from typing import Tuple, Optional

from fortuna.model.utils.spectral_norm import WithSpectralNorm


class FlaxSNGPRobertaExtractorForSequenceClassificationModule(nn.Module, WithSpectralNorm):
