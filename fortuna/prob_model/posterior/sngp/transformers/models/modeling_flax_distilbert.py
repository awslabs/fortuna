...
from transformers.models.distilbert.modeling_flax_distilbert import FlaxDistilBertModule, FlaxDistilBertPreTrainedModel
from typing import Tuple, Optional

from fortuna.model.utils.spectral_norm import WithSpectralNorm


class FlaxSNGPDistilBertExtractorForSequenceClassificationModule(nn.Module, WithSpectralNorm):
...
class FlaxSNGPDistilBertExtractorForSequenceClassification(FlaxDistilBertPreTrainedModel):
    ...
    def init_weights(self, rng: jax.random.PRNGKey, input_shape: Tuple, params: FrozenDict = None) -> FrozenDict:
        ...
        random_params = self.module.init(rngs, input_ids, attention_mask, return_dict=False)
