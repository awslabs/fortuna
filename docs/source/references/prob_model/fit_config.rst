...
- List[:class:`~fortuna.prob_model.fit_config.callback.Callback`]: to allow the user to perform custom actions at different stages of the training process.
...
.. autoclass:: fortuna.prob_model.fit_config.callback.Callback
